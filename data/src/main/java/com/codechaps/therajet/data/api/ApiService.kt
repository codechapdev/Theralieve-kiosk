package com.codechaps.therajet.data.api
...
//        @Part("isMember") isMember: RequestBody,
    ...
    /**
     * Get location endpoint
     * POST https://theralieve.co/api/kiosk/start-machine
     */
    @Multipart
    ...
    suspend fun startMachine(
        ...
        @Part("isMember") isMember: RequestBody,
        // additional if isMember false
        @Part("guestuserid") guestUserId: RequestBody?,
        // additional if isMember is true then
        @Part("user_id") userId: RequestBody?,
        @Part("plan_id") planId: RequestBody?,
        @Part("plan_type") planType: RequestBody?,
        @Part("total_points") creditPoints: RequestBody?,
