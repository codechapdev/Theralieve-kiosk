...
import com.codechaps.therajet.data.api.EquipmentDTO
import com.codechaps.therajet.data.api.EquipmentDetailDTO
    ...
    private fun EquipmentDTO.toDomain(): Equipment {
        return Equipment(
            ...
            equipment_data = equipment_data?.map {
                com.codechaps.therajet.domain.model.EquipmentDataItem(
