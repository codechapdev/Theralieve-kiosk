...
import com.codechaps.therajet.`data`.local.dao.EquipmentDao_Impl
import com.codechaps.therajet.`data`.local.dao.PlanDao
import com.codechaps.therajet.`data`.local.dao.PlanDao_Impl
      ...
      public override fun onValidateSchema(connection: SQLiteConnection): RoomOpenDelegate.ValidationResult {
        ...
        if (!_infoPlans.equals(_existingPlans)) {
          return RoomOpenDelegate.ValidationResult(false, """
              |plans(com.codechaps.therajet.data.local.entity.PlanEntity).
              | Expected:
        ...
        if (!_infoEquipment.equals(_existingEquipment)) {
          return RoomOpenDelegate.ValidationResult(false, """
              |equipment(com.codechaps.therajet.data.local.entity.EquipmentEntity).
              | Expected:
