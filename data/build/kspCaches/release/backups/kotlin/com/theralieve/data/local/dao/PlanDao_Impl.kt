...
public class PlanDao_Impl(
  ...
  init {
    ...
    this.__insertAdapterOfPlanEntity = object : EntityInsertAdapter<PlanEntity>() {
      protected override fun createQuery(): String = "INSERT OR REPLACE INTO `plans` (`id`,`planName`,`planPrice`,`validity`,`bulletPoints`,`planDesc`,`image`,`customerId`,`planType`,`membershipType`,`currency`,`points`,`status`,`createdDate`,`updatedDate`,`equipmentJson`,`frequency`,`frequencyLimit`,`discount`,`discountType`,`discountValidity`,`employeeDiscount`,`isForEmployee`,`isVipPlan`,`billingPrice`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
      ...
      protected override fun bind(statement: SQLiteStatement, entity: PlanEntity) {
        ...
        val _tmpBillingPrice: String? = entity.billingPrice
        if (_tmpBillingPrice == null) {
          statement.bindNull(25)
        } else {
          statement.bindText(25, _tmpBillingPrice)
        }
      }
    }
  }
  ...
  public override suspend fun getPlans(customerId: String): List<PlanEntity> {
    ...
    return performSuspending(__db, true, false) { _connection ->
      ...
      try {
        ...
        val _columnIndexOfBillingPrice: Int = getColumnIndexOrThrow(_stmt, "billingPrice")
